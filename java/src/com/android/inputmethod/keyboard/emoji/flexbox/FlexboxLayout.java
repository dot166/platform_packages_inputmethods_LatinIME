 ...
 * </ul>
 */
public class FlexboxLayout extends ViewGroup implements com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer {
     ...
     *
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection
     */
    private int mFlexDirection;

    /**
     * The current value of the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap}, the default value is {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap#NOWRAP}.
     *
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap
     */
     ...
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.AlignItems#FLEX_START}.
     *
     * @see com.android.inputmethod.keyboard.emoji.flexbox.AlignItems
     */
    private int mAlignItems;

    /**
     * The current value of the {@link com.android.inputmethod.keyboard.emoji.flexbox.AlignContent}, the default value is
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.AlignContent#FLEX_START}.
     *
     * @see com.android.inputmethod.keyboard.emoji.flexbox.AlignContent
     */
    ...
    /**
     * Holds reordered indices, which {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()} parameters are taken
     * into account
     */
    private int[] mReorderedIndices;

    /**
     * Caches the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()} attributes for children views.
     * Key: the index of the view reordered indices using the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()}
     * isn't taken into account)
     * Value: the value for the order attribute
     */
    private SparseIntArray mOrderCache;

    private com.android.inputmethod.keyboard.emoji.flexbox.FlexboxHelper mFlexboxHelper = new com.android.inputmethod.keyboard.emoji.flexbox.FlexboxHelper(this);
    ...
    public FlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, com.android.inputmethod.latin.R.styleable.FlexboxLayout, defStyleAttr, 0);
        mFlexDirection = a
                .getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_flexDirection, com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW);
        mFlexWrap = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_flexWrap, com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.NOWRAP);
        mJustifyContent = a
                .getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_justifyContent, JustifyContent.FLEX_START);
        mAlignItems = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_alignItems, com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.FLEX_START);
        mAlignContent = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_alignContent, com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.FLEX_START);
        mMaxLine = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_maxLine, NOT_SET);
        Drawable drawable = a.getDrawable(com.android.inputmethod.latin.R.styleable.FlexboxLayout_dividerDrawable);
        if (drawable != null) {
            setDividerDrawableHorizontal(drawable);
            setDividerDrawableVertical(drawable);
        }
        Drawable drawableHorizontal = a
                .getDrawable(com.android.inputmethod.latin.R.styleable.FlexboxLayout_dividerDrawableHorizontal);
        if (drawableHorizontal != null) {
            setDividerDrawableHorizontal(drawableHorizontal);
        }
        Drawable drawableVertical = a
                .getDrawable(com.android.inputmethod.latin.R.styleable.FlexboxLayout_dividerDrawableVertical);
        if (drawableVertical != null) {
            setDividerDrawableVertical(drawableVertical);
        }
        int dividerMode = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_showDivider, SHOW_DIVIDER_NONE);
        ...
        int dividerModeVertical = a
                .getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_showDividerVertical, SHOW_DIVIDER_NONE);
        if (dividerModeVertical != SHOW_DIVIDER_NONE) {
            mShowDividerVertical = dividerModeVertical;
        }
        int dividerModeHorizontal = a
                .getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_showDividerHorizontal, SHOW_DIVIDER_NONE);
    ...
    private void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAlignItems == com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.BASELINE) {
            for (com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine : mFlexLines) {
     ...
     * @see #setFlexDirection(int)
     */
    private void setMeasuredDimensionForFlex(@com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection int flexDirection, int widthMeasureSpec,
     ...
     * {@link #mFlexDirection} is either {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#ROW} or
    ...
    /**
     * Sub method for {@link #onLayout(boolean, int, int, int, int)} when the
     * {@link #mFlexDirection} is either {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#COLUMN} or
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#COLUMN_REVERSE}.
     *
     ...
     * ({@link #mFlexDirection} is either of {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#ROW} or
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#ROW_REVERSE}.
     *
     ...
     * ({@link #mFlexDirection} is either of {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#COLUMN} or
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#COLUMN_REVERSE}.
     *
     * @param canvas          the canvas on which the background will be drawn
     * @param isRtl           {@code true} when the horizontal layout direction is right to left,
     ...
     */
    public static class LayoutParams extends MarginLayoutParams implements com.android.inputmethod.keyboard.emoji.flexbox.FlexItem {

        /**
         * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()
         */
        private int mOrder = com.android.inputmethod.keyboard.emoji.flexbox.FlexItem.ORDER_DEFAULT;
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context
                    .obtainStyledAttributes(attrs, com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout);
            mOrder = a.getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_order, ORDER_DEFAULT);
            mFlexGrow = a
                    .getFloat(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_flexGrow, FLEX_GROW_DEFAULT);
            mFlexShrink = a.getFloat(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_flexShrink,
                    FLEX_SHRINK_DEFAULT);
            mAlignSelf = a
                    .getInt(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_alignSelf, com.android.inputmethod.keyboard.emoji.flexbox.AlignSelf.AUTO);
            mFlexBasisPercent = a
                    .getFraction(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_flexBasisPercent, 1, 1,
                            FLEX_BASIS_PERCENT_DEFAULT);
            mMinWidth = a
                    .getDimensionPixelSize(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_minWidth, NOT_SET);
            mMinHeight = a
                    .getDimensionPixelSize(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_minHeight, NOT_SET);
            mMaxWidth = a.getDimensionPixelSize(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_maxWidth,
                    MAX_SIZE);
            mMaxHeight = a.getDimensionPixelSize(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_maxHeight,
                    MAX_SIZE);
            mWrapBefore = a.getBoolean(com.android.inputmethod.latin.R.styleable.FlexboxLayout_Layout_layout_wrapBefore, false);
            a.recycle();
        }
