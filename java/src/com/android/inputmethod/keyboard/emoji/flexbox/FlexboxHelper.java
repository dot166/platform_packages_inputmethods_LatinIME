...
import static com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer.NOT_SET;
import static com.android.inputmethod.keyboard.emoji.flexbox.FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
import static com.android.inputmethod.keyboard.emoji.flexbox.FlexItem.FLEX_GROW_DEFAULT;
import static com.android.inputmethod.keyboard.emoji.flexbox.FlexItem.FLEX_SHRINK_NOT_SET;
...
class FlexboxHelper {
    ...
    private final com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer mFlexContainer;
    ...
    FlexboxHelper(com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer flexContainer) {
        mFlexContainer = flexContainer;
    }

    /**
     * Create an array, which indicates the reordered indices that
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()} attributes are taken into account.
    ...
    int[] createReorderedIndices(View viewBeforeAdded, int indexForViewBeforeAdded,
        ...
        if (viewBeforeAdded != null
                && paramsForViewBeforeAdded instanceof com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) {
            orderForViewToBeAdded.order = ((com.android.inputmethod.keyboard.emoji.flexbox.FlexItem)
                    paramsForViewBeforeAdded).getOrder();
        } else {
            orderForViewToBeAdded.order = com.android.inputmethod.keyboard.emoji.flexbox.FlexItem.ORDER_DEFAULT;
        }
    ...
    private List<Order> createOrders(int childCount) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) child.getLayoutParams();
    ...
    /**
     * Returns if any of the children's {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getOrder()} attributes are
    ...
    boolean isOrderChangedFromLastMeasurement(SparseIntArray orderCache) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) view.getLayoutParams();
    ...
    void calculateHorizontalFlexLines(FlexLinesResult result, int widthMeasureSpec,
            ...
            @Nullable List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> existingLines) {
    ...
    void calculateHorizontalFlexLinesToIndex(FlexLinesResult result, int widthMeasureSpec,
            int heightMeasureSpec, int needsCalcAmount, int toIndex, List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> existingLines) {
        calculateFlexLines(result, widthMeasureSpec, heightMeasureSpec, needsCalcAmount,
    ...
    void calculateFlexLines(FlexLinesResult result, int mainMeasureSpec,
        ...
        List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines;
        ...
        com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine = new com.android.inputmethod.keyboard.emoji.flexbox.FlexLine();
        ...
        for (int i = fromIndex; i < childCount; i++) {
            ...
            if (flexItem.getAlignSelf() == com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.STRETCH) {
            ...
            if (isWrapRequired(child, mainMode, mainSize, flexLine.mMainSize,
                ...
                flexLine = new com.android.inputmethod.keyboard.emoji.flexbox.FlexLine();
            ...
            if (isMainHorizontal) {
                if (mFlexContainer.getFlexWrap() != com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.WRAP_REVERSE) {
    ...
    private void evaluateMinimumSizeForCompoundButton(CompoundButton compoundButton) {
        com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) compoundButton.getLayoutParams();
     ...
     */
    private int getFlexItemSizeMain(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
     ...
     */
    private int getFlexItemSizeCross(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
            return flexItem.getHeight();
        }
     ...
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMarginLeft} (ViewGroup.MarginLayoutParams#getMarginStart isn't available
     ...
     */
    private int getFlexItemMarginStartMain(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
     ...
     * For the backward compatibility for API level < 17, the horizontal margin is returned using
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMarginRight} (ViewGroup.MarginLayoutParams#getMarginEnd isn't available
     ...
     */
    private int getFlexItemMarginEndMain(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
     ...
     */
    private int getFlexItemMarginStartCross(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
            return flexItem.getMarginTop();
        }
     ...
     */
    private int getFlexItemMarginEndCross(com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, boolean isMainHorizontal) {
        if (isMainHorizontal) {
            return flexItem.getMarginBottom();
        }
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#setFlexWrap(int)
     */
    private boolean isWrapRequired(View view, int mode, int maxSize, int currentLength,
                                   int childLength, com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem, int index, int indexInFlexLine, int flexLinesSize) {
        if (mFlexContainer.getFlexWrap() == com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.NOWRAP) {
            return false;
        }
    ...
    private boolean isLastFlexItem(int childIndex, int childCount,
            com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine) {
        return childIndex == childCount - 1 && flexLine.getItemCountNotGone() != 0;
    }

    private void addFlexLine(List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines, com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine, int viewIndex,
     ...
     * by the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMinWidth()}, {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMinHeight()},
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMaxWidth()} and {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getMaxHeight()} attributes.
     *
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#setFlexDirection(int)
    ...
    void determineMainSize(int widthMeasureSpec, int heightMeasureSpec, int fromIndex) {
        ...
        switch (mFlexContainer.getFlexDirection()) {
            case com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW: // Intentional fall through
            case com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW_REVERSE:
                ...
                break;
            case com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.COLUMN: // Intentional fall through
        ...
        List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines = mFlexContainer.getFlexLinesInternal();
        for (int i = flexLineIndex, size = flexLines.size(); i < size; i++) {
            com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine = flexLines.get(i);
     ...
     */
    private void expandFlexItems(int widthMeasureSpec, int heightMeasureSpec, com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine,
        ...
        for (int i = 0; i < flexLine.mItemCount; i++) {
            ...
            com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) child.getLayoutParams();
            int flexDirection = mFlexContainer.getFlexDirection();
            if (flexDirection == com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW || flexDirection == com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW_REVERSE) {
     ...
     */
    private void shrinkFlexItems(int widthMeasureSpec, int heightMeasureSpec, com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine,
            int maxMainSize, int paddingAlongMainAxis, boolean calledRecursively) {
    ...
    private int getChildWidthMeasureSpecInternal(int widthMeasureSpec, com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem,
            int padding) {
    ...
    private int getChildHeightMeasureSpecInternal(int heightMeasureSpec, com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem,
            int padding) {
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#getFlexDirection()
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#setFlexDirection(int)
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#getAlignContent()
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#setAlignContent(int)
     */
        ...
        if (mode == View.MeasureSpec.EXACTLY) {
            ...
            if (flexLines.size() == 1) {
                ...
                switch (mFlexContainer.getAlignContent()) {
                    case com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.STRETCH: {
                    ...
                    case com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.SPACE_AROUND: {
                        if (totalCrossSize >= size) {
                        ...
                        List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> newFlexLines = new ArrayList<>();
                        com.android.inputmethod.keyboard.emoji.flexbox.FlexLine dummySpaceFlexLine = new com.android.inputmethod.keyboard.emoji.flexbox.FlexLine();
                        dummySpaceFlexLine.mCrossSize = spaceTopAndBottom;
                        for (com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine : flexLines) {
                    ...
                    case com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.SPACE_BETWEEN: {
                        if (totalCrossSize >= size) {
                            break;
                        }
                    ...
                    case com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.CENTER: {
                        mFlexContainer.setFlexLines(
                                constructFlexLinesForAlignContentCenter(flexLines, size,
                                        totalCrossSize));
                        break;
                    }
                    case com.android.inputmethod.keyboard.emoji.flexbox.AlignContent.FLEX_END: {
    ...
    private List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> constructFlexLinesForAlignContentCenter(List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines,
    ...
    /**
     * Expand the view if the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#getAlignItems()} attribute is set to {@link
     * com.android.inputmethod.keyboard.emoji.flexbox.AlignItems#STRETCH} or {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getAlignSelf()} is set as
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#setAlignItems(int)
    ...
    void stretchViews(int fromIndex) {
        ...
        int flexDirection = mFlexContainer.getFlexDirection();
        if (mFlexContainer.getAlignItems() == com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.STRETCH) {
            int flexLineIndex = 0;
            if (mIndexToFlexLine != null) {
                flexLineIndex = mIndexToFlexLine[fromIndex];
            }
            ...
            for (int i = flexLineIndex, size = flexLines.size(); i < size; i++) {
                ...
                for (int j = 0, itemCount = flexLine.mItemCount; j < itemCount; j++) {
                    ...
                    com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) view.getLayoutParams();
                    if (flexItem.getAlignSelf() != com.android.inputmethod.keyboard.emoji.flexbox.AlignSelf.AUTO &&
                            flexItem.getAlignSelf() != com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.STRETCH) {
                        continue;
                    }
                    switch (flexDirection) {
                        case com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.ROW: // Intentional fall through
            ...
            for (com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine : mFlexContainer.getFlexLinesInternal()) {
     ...
     * ({@link com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#getFlexDirection()} is either {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#ROW} or
     * {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#ROW_REVERSE}).
     *
     * @param view     the View to be placed
     * @param flexLine the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexLine} where the View belongs to
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getAlignSelf()
     */
    void layoutSingleChildHorizontal(View view, com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine, int left, int top, int right,
                                     int bottom) {
        com.android.inputmethod.keyboard.emoji.flexbox.FlexItem flexItem = (com.android.inputmethod.keyboard.emoji.flexbox.FlexItem) view.getLayoutParams();
        ...
        switch (alignItems) {
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.FLEX_START: // Intentional fall through
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.STRETCH:
                if (mFlexContainer.getFlexWrap() != com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.WRAP_REVERSE) {
                ...
                break;
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.BASELINE:
                if (mFlexContainer.getFlexWrap() != com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.WRAP_REVERSE) {
                ...
                break;
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.FLEX_END:
                if (mFlexContainer.getFlexWrap() != com.android.inputmethod.keyboard.emoji.flexbox.FlexWrap.WRAP_REVERSE) {
                    view.layout(left,
                ...
                break;
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.CENTER:
     ...
     * ({@link com.android.inputmethod.keyboard.emoji.flexbox.FlexContainer#getFlexDirection()} is either {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection#COLUMN} or
     ...
     * @see com.android.inputmethod.keyboard.emoji.flexbox.FlexItem#getAlignSelf()
     */
    void layoutSingleChildVertical(View view, com.android.inputmethod.keyboard.emoji.flexbox.FlexLine flexLine, boolean isRtl,
        ...
        switch (alignItems) {
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.FLEX_START: // Intentional fall through
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.STRETCH: // Intentional fall through
            case com.android.inputmethod.keyboard.emoji.flexbox.AlignItems.BASELINE:
                if (!isRtl) {
     ...
     */
    void clearFlexLines(List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines, int fromFlexItem) {
