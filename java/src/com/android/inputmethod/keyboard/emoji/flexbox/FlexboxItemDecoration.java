...
import com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection;
import com.android.inputmethod.keyboard.emoji.flexbox.FlexLine;
import com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager;

/**
 * {@link RecyclerView.ItemDecoration} implementation that can be used as item decorations between
 * view holders within the {@link com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager}.
 *
...
public class FlexboxItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(
        ...
        com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager layoutManager = (com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager) parent.getLayoutManager();
        List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines = layoutManager.getFlexLines();
    ...
    private void setOffsetAlongCrossAxis(Rect outRect, int position,
                                         com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager layoutManager, List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines) {
        if (flexLines.size() == 0) {
            return;
        }
    ...
    private void setOffsetAlongMainAxis(Rect outRect, int position,
                                        com.android.inputmethod.keyboard.emoji.flexbox.FlexboxLayoutManager layoutManager, List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines, int flexDirection) {
        ...
        if (layoutManager.isMainAxisDirectionHorizontal()) {
            ...
            if (flexDirection == com.android.inputmethod.keyboard.emoji.flexbox.FlexDirection.COLUMN_REVERSE) {
     ...
     */
    private boolean isFirstItemInLine(int position, List<com.android.inputmethod.keyboard.emoji.flexbox.FlexLine> flexLines,
